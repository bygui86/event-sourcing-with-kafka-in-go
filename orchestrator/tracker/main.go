...
var config = struct {
	...
	TrackerTopic:    "tracker-t",
	TrackerGroup:    "tracker-g",
	WorkerTopic:     "worker-t",
}
...
func main() {
	...
	logger.Log("msg", "running tracker", "consumer_group", config.TrackerGroup, "tracker_topic", config.TrackerTopic, "worker_topic", config.WorkerTopic)
